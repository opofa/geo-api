...
public class PointOfInterestController {
    ...
    public EntityModel<PointOfInterestDto> findById(@Parameter(description = "The id of the POI", required = true, example = "00000000-0000-0000-0000-000000000000") @PathVariable UUID id) {
    ...
    public EntityModel<PointOfInterestDto> update(@Parameter(description = "The id of the POI", required = true, example = "00000000-0000-0000-0000-000000000000") @PathVariable UUID id, @Valid @RequestBody SavePointOfInterestCommand savePointOfInterestCommand) {
    ...
    public void deleteById(@Parameter(description = "The id of the POI", required = true, example = "00000000-0000-0000-0000-000000000000") @PathVariable UUID id) {
